    ...
    public class CustomOAuthProvider : OAuthAuthorizationServerProvider
    {
            ...
            OAuthValidateClientAuthenticationContext context)
        {
            ...
            if (audience == null)
            {
                context.SetError(
                    "invalid_clientId", 
                    string.Format("Invalid client_id '{0}'", context.ClientId)
                    );
                return Task.FromResult<object>(null);
            }
            ...
            OAuthGrantResourceOwnerCredentialsContext context)
        {
            ...
            var userProvider = new UserProvider(new Rest.Models.AlphaMedicContext.AlphaMedicContext());
           ...
           /* foreach (var userClaim in user.UserClaims)
            {
                ...
                identity.AddClaim(new Claim(ClaimTypes.Role, userClaim.ClaimValue));
